...
@section('content')
    <div class="container create-container px-3">

        <section id="apartment-form">
            ...
            <div class="create-wrapper pb-2">
                <form class="p-2 m-5 my_form" action="{{route('users.apartments.store', $newAddress)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <button type="submit" class="btn btn-custom ml-5 mb-3">Add your apartment</button>
